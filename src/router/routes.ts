...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'rolsusuari/list', component: () => import('pages/RolsUsuari.vue') },
      { path: 'rolsusuari', component: () => import('pages/RolsUsuariForm.vue') },
      { path: 'rolsusuari/:id', component: () => import('pages/RolsUsuariForm.vue') },
